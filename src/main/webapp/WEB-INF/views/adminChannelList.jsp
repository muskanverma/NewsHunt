<html>
    <head>
        ...
        <script>
        	...
        	m.controller("channelController",function($scope,$http){
        		 $scope.channelListData = function(){
	 				...
	 				$scope.updatechannel = function(recordSelected){
    ...
    <body ng-app = "newshunt">
        <div ng-controller="channelController" ng-init="channelListData()">
        ...
        <div class="main">
         	 <div class="table-responsive">          
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <tr ng-repeat="x in channelList">
                        <td>{{x.id}}</td>
                        <td>{{x.title}}</td>
                        <td>{{x.url}}</td>
                        <td>{{x.description}}</td>
   						<td>{{x.image}}</td>
   						<td><button class="btn btn-small btn-success" ng-click="updatechannel(x)">UPDATE</button></td>
							    ...
							    <div class="modal-dialog">
							      <div class="modal-content">
							        ...
							        <div class="modal-body">
							          name <input type = "text" ng-model="rec.title"/>
