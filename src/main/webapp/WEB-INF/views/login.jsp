        ...
        <div class="container" ng-controller="userInfo">    
            <div class="card">
                <div class="card-header">
                    <p><strong>Login</strong> to get going !</p>
                </div>
                <br>
                <br>
                <div class="card-body">
                    <form>
                        ...
                        <br>
                        <br>
                        <button type="button" class="btn btn-success" ng-click="checkInfo()">LOGIN</button>
                    </form>
                </div>
             ...
             <div ng-if = "check==0">
                 <img src="${pageContext.request.contextPath}/resources/loader.gif">
