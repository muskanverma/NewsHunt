<html>
    <head>
        ...
        <script>
        	...
        	m.controller("MenuController",function($scope,$http){
        		 ...
        		 $scope.Menu = function(){
        			 data = {name:$scope.name, url:$scope.url};
        			$http.post("addMenu",data).then(function(resp){
        				
        				if(resp.data==1){
        					alert("Record Inserted in Menu");
        				}
    ...
    <body ng-app = "newshunt">
        ...
        <div class="main">
     		...
     		<br>
     		<button type="button" class="btn btn-success" ng-click="Menu()">SUBMIT</button>
     		</form>
